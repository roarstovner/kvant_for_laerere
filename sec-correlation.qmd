...
Lineær regresjon kan ses på som en mer avansert og kraftfull versjon av Pearsons korrelasjon, som vi så på i @sec-associations. For å se nærmere på dette, henter vi frem igjen datasettet *[parenthood.csv](data_and_tables/parenthood.csv)*. Husker du eksempelet? Vi prøvde å finne ut hvorfor Danielle var så gretten, og hypotesen var at det skyldtes for lite søvn. Vi lagde et spredningsplott som viste sammenhengen mellom antall timer søvn og graden av grettenhet dagen etter (@fig-associations-scatter-dani), og fant en sterk negativ korrelasjon på $r = -0{,}90$.
