...
Danielle J. Navarro, David R. Foxcroft, and Roar B. Stovner. (2025). Kvantitativ metode for lærere. https://kvant.roarstovner.no .
...
The first prompt was a translation prompt, see <.chores/oversett-replace.md>. This produced abysmal Norwegian text, so I also ran a copy-editing prompt, see <.chores/spraakvask-replace.md>. I then edited the text manually. I think no paragraph of the book is pure AI translation, I always needed some manual cleaning, even when I wanted to keep the original content unchanged.

I used various models. I used claude-3-7-sonnet, claude-sonnet-4, gpt-4o, gemini-2.0-flash and gemini-2.5-flash. Starting with gemini-2.5-flash and gpt-5, the initial Norwegian version was actually quite good. It seems claude-sonnet-4 has caught up somewhat to the others' Norwegian proficiency, also.

I think I spent less than 5 USD on translation and copy-editing.