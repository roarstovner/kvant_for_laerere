...
En **konfunder** [^sec-design-konfunder] til variablene $A$ og $B$ er en variabel $C$ som er slik at den påvirker både $A$ og $B$. Altså $C\rightarrow A$ og $C\rightarrow B$. Ofte tegner man dette i et diagram slik som dette:
