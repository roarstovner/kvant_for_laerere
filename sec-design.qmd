...
Det som gjør randomiserte kontrollstudier så nyttige er **tilfeldig gruppeinndeling**, også kalt *tilfeldig tilordning*. Når vi fordeler deltakerne i ulike grupper basert på ren tilfeldighet, oppnår vi noe ganske elegant: De som naturlig ville reagert positivt eller negativt på intervensjon blir jevnt spredt utover alle gruppene. Eventuelle forskjeller vi ser i resultatene, vil skyldes intervensjonen vi tester, og ikke at de som responderer best eller dårligst på intervensjonen systematisk hører til i samme gruppe.

Mange synes forklaringen i avsnittet over, at randomiseringen gjør at verdien på utfallsvariabelen blir jevnt fordelt på tvers av gruppene, er overbevisende, men mange lurer likevel på hvorfor ikke konfundere er et problem. Vil ikke konfundere, slik som underliggende forskjeller mellom deltagerne, kunne påvirke resultatet? Nei, for alle de underliggende forskjellene mellom deltakerne -- som evner, motivasjon, bakgrunn og andre personlige egenskaper -- blir også balansert mellom intervensjons- og kontrollgruppen, fordi inndelingen er tilfeldig.
...
[^design-elevundersokelsen]: Se <https://www.udir.no/tall-og-forskning/statistikk/statistikk-grunnskole/elevundersokelsen/>.
