...
-   **For nominelle variable** kan du hverken bruke gjennomsnitt eller median, typetall er det eneste sentraltendenset som fungerer.
...
Kvartilbredden har den samme gode egenskapen til medianen, den blir ikke påvirket av ekstreme verdier. Bare tenk på hvordan kvartilbredden ikke blir påvirket når Haaland satte seg ved bordet i eksempelet i @sec-descriptive-mean-or-median. Merk at kvartilbredden ikke fungerer like godt for å vise spredningen rundt et gjennomsnitt. Årsaken er at gjennomsnittet kan ligge utenfor 25. og 75. persentil, akkurat slik den vil gjøre i Haaland-eksempelet.
...
Husk likevel at standardavviket sammenfatter spredningen i ett enkelt tall og sier ingenting om _formen_ på fordelingen. To variable kan ha samme standardavvik selv om histogrammene deres ser helt forskjellige ut. Dette gjelder for alle sentraltendensene og spredningsmålene: figurer gir ofte et bedre bilde enn tallene alene.
