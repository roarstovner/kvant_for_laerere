...
For å få en forståelse av dataene, må vi beskrive dem med tall og figurer. Vi organiserer kapittelet etter variabeltype: først kategoriske variable (nominelle og ordinale), deretter kontinuerlige variable (intervall- og forholdstallsnivå). De kategoriske variablene er markert med et symbol med tre prikker i jamovi, og er altså _Land_, _Trinn_, _Kjønn_ og _Forventet utdanning_.
...
Frekvenstabellen er til høyre i figuren. De viser en opptelling av _Forventet utdanning_-variabelen. I første kolonne er variabelen øverst, med de ulike verdiene under. I "Counts"-kolonnen finner du hvor mange det var av hver verdi. I tillegg har tabellen litt ekstra snadder. Kolonnen "% of Total" viser hvor mange prosent dette utgjør. I "Cumulative %" summerer man de foregående prosentene. Slik ser man at 66,5 % av elevene skal ha "Høyere utdanning" eller "Kort utdanning".

Stort mer er det ikke å si om frekvenstabeller.
...
Hvis du vil sammenligne stolpediagram mellom undergrupper -- for eksempel sammenligne forventet utdanning mellom land -- kan du bruke "Split by" i jamovi. Du lærer mer om slike undergruppeanalyser i @sec-associations.
...
Å se på rådataene i tabellen på starten av kapittelet, @tbl-ICCS-data, fortalte oss lite. Likevel viser jeg et histogram av *likestilling*-dataene, slik at vi vet hva det er vi prøver å beskrive med deskriptiv statistikk, se @fig-descriptive-ICCS-histogram. Histogrammer forklares i detalj i neste delkapittel.
...
En enkel tommelfingerregel: Bruk medianen hvis dataene er skjeve eller har ekstremverdier; bruk gjennomsnittet ellers.
...
-   **Histogrammer og tetthetskurver**: [Histogrammer] viser fordelingen av tallvariable og er ofte det mest informative verktøyet.
...
-   **Boksplott og fiolinplott**: [Boksplott] og [Fiolinplott] er kompakte måter å visualisere spredning og sentraltendens, spesielt nyttige for å sammenligne undergrupper.
