...
#| fig-cap: !expr paste0("Fra ett utvalg til usikkerheten i gjennomsnittet, vist for utvalget på ", se_n, " elever. De to panelene deler vannrett akse, så innsnevringen er reell og ikke en illusjon skapt av ulik skala. De vannrette pilene viser spredningen i hvert panel")
#| fig-subcap:
...
Problemet med formelen for standardfeilen er at den baserer seg på populasjonens standardavvik. Søren også, den vet vi jo ikke; vi har bare data på de 64 elevene i utvalget vårt. I mer matematisk presise forklaringer må man først estimere populasjonsstandardavviket. Siden det blir for avansert for oss, sier jeg bare at formelen jeg viste for standardfeilen må ganges med Bessels korreksjon, som er $\frac{n}{n-1}$. Dette gjør at den virkelige standardfeilen er bittelitt høyere enn den vi estimerte. For alt annet enn ørsmå utvalg er forskjellen helt ubetydelig, så du trenger ikke tenke mer på den.
:::
...
@fig-inf-ci viser konfidensintervallet tegnet på gjennomsnittets utvalgsfordeling. Det skraverte området utgjør 95 % av fordelingen og er alt som ligger innenfor 2 standardfeil av estimatet. Det er nettopp dette midtpartiet konfidensintervallet fanger. Legg merke til hvor smalt det er sammenlignet med spennet av lesehastigheter.
