...
Når en variabel er normalfordelt gjelder en nyttig tommelfingerregel: rundt 68 % av verdiene ligger innenfor ett standardavvik fra gjennomsnittet, og rundt 95 % innenfor to. For IQ vil det si at omtrent 68 % har en skår mellom 85 og 115, og omtrent 95 % mellom 70 og 130. Merk at regelen kun gjelder for normalfordelte variable -- for fordelinger med andre former, slik som _Likestilling_ i @fig-diagram-ICCS-histogram, kan den være svært misvisende.
...
## Estimering av populasjonsparametere {#sec-estimation-parameters}
...
Det er ofte nødvendig å regne ut en standardskår fordi måleenheten i seg selv ikke sier så mye. Hvis jeg svarte på spørreskjemaet i ICCS-studien, kunne jeg spurt forskerne "Hvor mye var jeg for likestilling?" og de kunne svart "58", men svaret ville ikke vært særlig informativt. Det ville vært mye mer informativt hvis de svarte "Du skåret litt over gjennomsnittet." Det er akkurat dette en standardskår gir deg.

En standardskår (også kalt en _z_-skår) er definert til å være antall standardavvik unna gjennomsnittet:

$$z = \frac{\text{opprinnelig skår} - \text{gjennomsnitt}}{\text{standardavvik}}$$

Hvis gjennomsnittet på _Likestilling_ var 54,8 og standardavviket var 11,5, ville en skår på 58 gitt $z = (58 - 54{,}8) / 11{,}5 = 0{,}28$. Det betyr at skåren ligger 0,28 standardavvik over gjennomsnittet. En skår på $z = -0{,}3$ betyr at personen svarte 0,3 standardavvik under gjennomsnittet.

Standardskårer er spesielt nyttige for å sammenligne verdier på tvers av forskjellige skalaer. Anta at vennen min Bård svarte på et annet spørreskjema om likestilling og fikk skår 4. Verdien min fra ICCS, 58, er overhodet ikke sammenliknbar med verdien hans, 4, fordi skalaene er ulike. Men hvis vi vet at Bård sin standardskår var $z = 3{,}1$ og min var $z = 0{,}28$, kan vi sammenlikne: Bård skåret enormt langt over gjennomsnittet i sin studie, mens jeg skåret litt over i min. Merk at standardskårene kun er sammenliknbare hvis utvalgene er det.
...
- [Standardskår] (_z_-skår) som lar deg plassere enkeltobservasjoner i forhold til gjennomsnittet og sammenligne verdier på tvers av skalaer.
