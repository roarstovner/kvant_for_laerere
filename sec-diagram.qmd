...
## Stablede stolpediagrammer {#sec-diagram-stacked-bar}
...
:::{#fig-diagram-equ-x-edu out.width="100%" layout-ncol=2}
```{r}
...
#| fig-cap: Graph by Roser -@roser2022. Licensed as CC-BY.
#| classes: .enlarge-image
#| out-width: "100%"
...
- **Vanlige plott**: Vi har fokusert på standardgrafer som statistikere ofte bruker, som [Stolpediagram], [Stablede stolpediagram], [Histogrammer], [Boksplott] og [Spredningsplott]. Det er verdt å vite hvilke variabeltyper som passer til hver type plott, i tillegg til å kunne tolke dem.
