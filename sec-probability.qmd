...
^[De som husker den frekventistiske definisjonen av sannsynlighet vil kanskje kverulere og si at det bare er *andelen* ganger $X$ inntreffer som må gå mot null når $N$ går mot uendelig, og at det derfor _er_ mulig. De har rett.]
...
^[Hvis dere ønsker en føling med hvordan det matematiske uttrykket til normalfordelingen er, værsågod: $$p(X|\mu, \sigma) = \frac{1}{\sigma\sqrt{2\pi}}e^{-\frac{(X-\mu)^2}{2\sigma^2}}$$ Wow, hva gjør $\pi$ der?!]
...
**$\chi^2$-fordelingen** dukker opp mange steder i statistikk. Vi vil se den når vi analyserer kategoriske variable i @sec-categorical, men den er faktisk svært vanlig. Matematisk sett oppstår $\chi^2$-fordelingen når vi har flere normalfordelte variabler, kvadrerer verdiene deres og legger dem sammen (en "sum av kvadrater"). Dette viser seg å være utrolig nyttig! @fig-probability-chi-square viser hvordan en $\chi^2$-fordeling ser ut.

**$F$-fordelingen** ligner litt på $\chi^2$-fordelingen og brukes når vi skal sammenligne to $\chi^2$-fordelinger. Dette høres kanskje rart ut, men er faktisk svært viktig i dataanalyse. Siden $\chi^2$ er nøkkelfordelingen for "summer av kvadrater", bruker vi $F$-fordelingen når vi vil sammenligne to forskjellige "summer av kvadrater". Vi skal se eksempler på dette i @sec-means. @fig-probability-F viser hvordan $F$-fordelingen ser ut.
