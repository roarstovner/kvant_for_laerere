...
![Operasjonalisering av konstruktet _alder_. Lengst til høyre er 'Alder' en variabel i datasettet som har verdiene 21, 38 og 72 for de tre første forskningsdeltagerne.](images/fig-operasjonalisering.png){#fig-operasjonalisering fig-alt="Lengst til venstre er 'Teoretisk konstrukt: Alder' med en pil til 'Målemetode: Selvrapportering fra nettspørreskjema: 'hvilket år ble du født?''. Det står 'operasjonalisering' på pila. Derfra går det en pil, 'datainnsamling', til 'Variabel'. Ved 'Variabel' er det et datasett med 'Fødselsår' og 'Alder'. Fra 'Fødselsår' til 'Alder' går det en liten pil, 'Etterbehandling av data'."}
...
![I en ordinal variabel er ikke nødvendigvis avstanden mellom kategoriene like store. Her markerer pilene avstanden mellom kategoriene, og avstanden mellom kategori (1) og (2) er større enn de andre.](images/fig-ordinal.png){#fig-ordinal fig-alt="Den ordinale variabelen \"enighet med vitenskapelig konsensus\" med forskjellig avstand mellom hvert svaralternativ. Det er størst avstand mellom (1) og (2)."}
...
### En målings validitet {#sec-measurement-validity}
...
![At målemetoder fanger for lite eller for mye kalles underrepresentasjon og irrelevans](images/fig-construct.png){#fig-construct fig-alt="En ellipse det står \"Konstruktet som skal måles\" i. En anne ellipse, som delvis overlapper, er markert med \"Hva målemetoden måler\". Området inne i konstrukt-ellipsen som ikke overlapper er underrepresentasjon og området utenfor konstrukt-ellipsen, men inne i målemetode-ellipsen, er irrelevans."}
...
- [Vurdering av målingers validitet](#sec-measurement-validity). Måler målemetoden din det du ønsker?
