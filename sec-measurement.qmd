...
## Etiske sider ved kvantitativ måling av folk {#sec-categorisation-ethics}

Det er ikke bare vanskelig å lage reliable og valide målinger av mennesker, målingene kan også ha dype etiske konsekvenser. Jeg viser dere bare to av de mest nærliggende etiske problemene.

Det første etiske problemet kan oppsummeres med at "målinger skaper folk". Alex starter i første klasse som en vanlig gutt, etter femtetrinn tar Alex nasjonale prøver i lesing, der Alex skårer på "mestringsnivå 1", foreldre og lærere begynner å tenke på Alex som "en svak leser" og "faglig svak". Underveis forsvinner konteksten rundt prøven (kanskje Alex var sliten), usikkerheten prøven er beheftet med (kanskje Alex skåret rett under grensen for nivå 2) eller at prøven var urettferdig for Alex (Alex sleit med teksten som handlet om skøyter, for Alex har hverken sett eller prøvd skøyter). Likevel har prøven påvirket andres syn på Alex, og trolig hans eget syn på seg selv.

Du tror kanskje man kan innvende "men han leser jo litt dårlig, da"

Noen ganger utløser målingene ekstra ressurser. Kanskje Alex blir kalt inn til spesialpedagoger som tar en spesiell type kvantitativ måling, en som skal kartlegge dysleksi. Hvis prøven sier at Alex har dysleksi får han mange rettigheter, hvis ikke får han ingenting. Men samtidig kan diagnosen senke forventningene andre har til ham og han har til seg selv. La oss håpe at grenseverdien for dysleksimålingen er satt på bakgrunn av en svært grundig vurdering av både etikk og validitet. (Jeg har ingen grunn til å tro noe annet, altså.)

Hvis du betviler Dette er et eksempel på noe bredere; det er ikke bare slik at målinger skaper *folk*, målinger kan skape *alt mulig rart*, en prosess som kalles **tingliggjøring**. Jeg har selv vært med på å lage kvantitative målinger som skal måle kvaliteten av undervisning i livsmestring
